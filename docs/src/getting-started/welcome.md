...
- Jika berhasil, akan ada pesan seperti ini

```js:no-line-numbers
IMPORTANT NOTES:
 - Congratulations! Your certificate and chain have been saved at:
   /etc/letsencrypt/live/megumii.eu/fullchain.pem
   Your key file has been saved at:
   /etc/letsencrypt/live/megumii.eu/privkey.pem
   Your cert will expire on 2023-12-14. To obtain a new or tweaked
